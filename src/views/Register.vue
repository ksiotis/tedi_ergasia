        ...
        <b-form @submit="onSubmit" id="registration-form" class="">
            <div class="d-flex">
                ...
                <div class="d-flex flex-column set-width mr-5">
                    ...
                    <b-form-group label="Όνομα Χρήστη" label-for="username" label-size="sm" class="mt-auto">
                ...
                <div class="d-flex flex-column set-width">
                    ...
                    <b-form-group id="file" class="mt-4 align-self-center">
                        <b-form-file @input="loadFile" v-model="form.file" accept="image/jpeg, image/png, image/gif" placeholder="Επιλογή Εικόνας"></b-form-file>
                    </b-form-group>
            ...
            <div class="d-flex flex-fill">
                ...
                <div class="d-flex flex-column set-width mr-5">
                    ...
                    <div class="">
                        ...
                        <b-form-group id="checkboxes" class="d-flex mb-0">
                            <b-form-checkbox id="checkbox-1" v-model="form.host" name="checkbox-1" class="ml-1">Είμαι οικοδεσπότης</b-form-checkbox>
                ...
                <div class="d-flex set-width">
                    <b-form-group label="Επιβεβαίωση Κωδικού Πρόσβασης" label-for="confirmpassword" label-size="sm" class="set-width">
                        <b-form-input id="confirmpassword" v-model="form.confirmpassword" type="password" required></b-form-input>
                    </b-form-group>
                </div>
            </div>

            <div class="d-flex flex-fill mt--1">
                <b-button id="register-btn" type="submit" class="ml-auto mr-5 px-5 py-2">Δημιουργία Λογαριασμού</b-button>
            </div>
        </b-form>
    </div>
</template>
